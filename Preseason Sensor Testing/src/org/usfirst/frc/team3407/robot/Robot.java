...
import com.kauailabs.navx.frc.AHRS;//navx gyro
/**
...
public class Robot extends IterativeRobot {
   ...
   // public static String b
    ...
    public void robotInit() {
		...
		data = NetworkTable.getTable("RobotData");
		sensors = data.getTable("Sensors");
...
//        chooser.addObject("My Auto", new MyAutoCommand());
    ...
    public void teleopPeriodic() {
        ...
        double Yval = accel.getY() * 32.174049;
        double Xval = accel.getX() * 32.174049;
        double Zval = accel.getZ() * 32.174049;
        double yaw = ahrs.getAngle();
        data.putNumber("Yval", Yval);
        data.putNumber("Xval", Xval);
        data.putNumber("NavXtest", yaw);
        sensors.putNumber("Zval", Zval);
        System.out.println("angle is:" + yaw);
